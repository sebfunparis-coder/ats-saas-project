...
export function RegisterPage() {
  ...
  const fillRandom = () => {
    const firstNames = ['Alice', 'Thomas', 'Sophie', 'Marc', 'Julie', 'Pierre', 'Emma', 'Lucas'];
    const lastNames = ['Martin', 'Dupont', 'Bernard', 'Leroy', 'Moreau', 'Simon', 'Laurent'];
    const companies = ['TechCorp', 'InnovaRH', 'PulseRecruit', 'TalentPro', 'NexusRH', 'SkillBridge'];
    const r = (arr) => arr[Math.floor(Math.random() * arr.length)];
    const fn = r(firstNames), ln = r(lastNames);
    const rand = Math.floor(Math.random() * 9000) + 1000;
    setFormData({
      firstName: fn,
      lastName: ln,
      email: `${fn.toLowerCase()}.${ln.toLowerCase()}${rand}@test.fr`,
      company: r(companies),
      phone: '',
      password: 'Test1234!',
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{
            ...
            Sans engagement, choisissez votre plan
          </p>
        </div>
        ...
        {/* Bouton remplissage auto pour les tests */}
        <button
          type="button"
          onClick={fillRandom}
          style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{
            ...
            <div>
              ...
              />
              {errors.firstName && <div role="alert" style={errorStyle}>{errors.firstName}</div>}
            </div>
            ...
            <div>
              ...
              />
              {errors.lastName && <div role="alert" style={errorStyle}>{errors.lastName}</div>}
            </div>
          </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            />
            {errors.email && <div role="alert" style={errorStyle}>{errors.email}</div>}
          </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            />
            {errors.company && <div role="alert" style={errorStyle}>{errors.company}</div>}
          </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            />
            {errors.password && <div role="alert" style={errorStyle}>{errors.password}</div>}
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            />
            {errors.confirmPassword && <div role="alert" style={errorStyle}>{errors.confirmPassword}</div>}
          </div>
