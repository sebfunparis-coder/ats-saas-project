...
export function FormField({
  ...
  // Clone children pour passer la prop error — uniquement aux composants (Input/Select/...),
  // jamais aux éléments DOM natifs (input/div...) qui la renverraient telle quelle sur le DOM
  // et déclencheraient "Received `false` for a non-boolean attribute `error`".
