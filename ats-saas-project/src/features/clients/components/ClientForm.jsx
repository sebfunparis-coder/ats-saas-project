    ...
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      ...
      <Modal.Body>
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '20px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '16px', marginBottom: '12px', paddingBottom: '8px', borderBottom: '2px solid #E5E7EB' }}>
              <h3 style={{ ...sectionTitleStyles, margin: 0, border: 'none', padding: 0 }}>👥 Contacts ({contacts.length})</h3>
              <button
                type="button"
                onClick={addContact}
