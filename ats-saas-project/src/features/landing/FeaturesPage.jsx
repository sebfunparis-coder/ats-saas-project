          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '60px', alignItems: 'center' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                {[
                  { name: 'Marie Dupont', score: 92, color: '#10B981' },
                  { name: 'Pierre Martin', score: 87, color: '#34D399' },
                  { name: 'Sophie Laurent', score: 78, color: '#FBBF24' },
                  { name: 'Jean Dubois', score: 65, color: '#F59E0B' }
                ].map((candidate, i) => (
                  <div key={i} style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                      <span style={{ fontSize: '14px', fontWeight: '600', color: '#374151' }}>{candidate.name}</span>
                      <span style={{ fontSize: '14px', fontWeight: '700', color: candidate.color }}>{candidate.score}%</span>
                    </div>
                    <div style={{
                      height: '8px',
                      background: '#E5E7EB',
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <span style={{
                        fontSize: '24px',
                        fontWeight: '700',
                        color: item.trend === '↑' ? '#10B981' : '#10B981'
                      }}>
                        {item.value}
                      </span>
                      <span style={{ fontSize: '28px', color: item.trend === '↑' ? '#10B981' : '#10B981' }}>
                        {item.trend}
                      </span>
                    </div>
                  </div>
