...
export function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Oui ! Nous offrons un <strong>essai gratuit de 14 jours</strong> sur tous nos plans, sans carte bancaire requise. Vous pouvez tester toutes les fonctionnalités en conditions réelles avant de vous engager.'
    },
    {
      category: 'pricing',
