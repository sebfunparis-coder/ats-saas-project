...
export const ANALYTICS_CONFIG = {
  // ⚠️ IMPORTANT: Remplacer par votre vrai Measurement ID
  MEASUREMENT_ID: 'G-XXXXXXXXXX', // TODO: Remplacer par votre GA4 Measurement ID

  // Activer/désactiver analytics
  ENABLED: false, // TODO: Mettre à true en production

  // Activer debug mode (logs console)
